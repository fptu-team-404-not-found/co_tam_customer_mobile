...
class ListOfVoucher {
  ...
  ListOfVoucher({this.data, this.success, this.message, this.statusCode});
  factory ListOfVoucher.fromJson(Map<String, dynamic> json) => _$ListOfVoucherFromJson(json);

  Map<String, dynamic> toJson() => _$ListOfVoucherToJson(this);
